...
import type { DesignDiscoveryPageData } from "@/lib/types";
...
import pageStyles from "./DesignDiscoveryPage.module.css";

interface Props {
  data: DesignDiscoveryPageData;
}

export function DesignDiscoveryPageClient({ data }: Props) {
  return (
    <>
      <ServiceHero
        tag={data.hero.tag}
        ...
        titleNode={
          <>
            Design discovery helps you{" "}
            <span style={{ fontFamily: "var(--font-serif)" }}>visualize</span>{" "}
            your product for clarity in{" "}
